...
fn assemble_flat(
    ...
    // None/Compact/Budgets are frameless (overhead 0): Compact and Budgets
    // return from their own bespoke assembly before reaching here; None
    // flows through this generic path with no chrome.
